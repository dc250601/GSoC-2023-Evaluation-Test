...
class model(torch.nn.Module):
    ...
    def __init__(self, channels = 1, N=4,image_shape = (128,128), group = "cyclic"):
        ...
        self.block4 = nn.SequentialModule(
            ...
            nn.InnerBatchNorm(nn.FieldType(self.r2_act, 128*[self.r2_act.regular_repr])),
            ...
            nn.ReLU(nn.FieldType(self.r2_act, 128*[self.r2_act.regular_repr]), inplace=True),
            #------------------------------------------------------------------------------
            nn.PointwiseAvgPoolAntialiased(nn.FieldType(self.r2_act, 128*[self.r2_act.regular_repr]),
                                           sigma=0.66,
                                           stride=2)   
        )
        ...
        self.final_pool = nn.PointwiseMaxPoolAntialiased(nn.FieldType(self.r2_act, 128*[self.r2_act.regular_repr]),
                                                         sigma=0.66,
                                                         stride=1,
                                                         kernel_size = 4)
        self.gpool = nn.GroupPooling(nn.FieldType(self.r2_act, 128*[self.r2_act.regular_repr]))
